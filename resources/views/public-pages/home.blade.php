...
<link href="https://fonts.googleapis.com/css2?family=Caveat:wght@500&family=Quattrocento:wght@700&display=swap" rel="stylesheet">
@endsection
...
<div class="p-0">
<div class="p-1" >
            <b style="margin-top:20px; font-size: 75px; font-family: 'Caveat', cursive; ">Mita Alat Pesta</b>
            <p style="margin-top:-15px; font-size: 25px; font-family: 'Caveat', cursive;">
            Persewaan Alat Pesta Terbaik di Surabaya</p>
        </div>
<div class="jumbotron bg-image-center d-flex justify-content-center align-items-center mb-4"
        style="min-height: 170px; object-fit: cover; background: linear-gradient(to bottom, #e5e5f7 -5%, #ffffff 28%);">
